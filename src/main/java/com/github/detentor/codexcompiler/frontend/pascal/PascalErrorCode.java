...
public enum PascalErrorCode
{
    ...
    /**
     * Cria um código de erro, com status 0, para a mensagem passada como parâmetro
     * @param theMessage
     */
	private PascalErrorCode(final String theMessage)
	{
		this(0, theMessage);
	}

	/**
	 * Cria um código de erro, com o status e a mensagem passados como parâmetro
	 * @param theStatus
	 * @param theMessage
	 */
	private PascalErrorCode(final int theStatus, final String theMessage)
	{
